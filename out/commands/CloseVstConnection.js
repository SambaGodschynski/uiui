...
class CloseVstConnection extends ACommand_1.ACommand {
    execute(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            const treeItem = args[0][0];
            const player = Player_1.getPlayer();
            yield player.closeVstConnection();
            treeItem.connection.state = VstConnectionsProvider_1.ConnectionState.Open;
            VstConnectionsProvider_1.getVstConnectionProvider().refresh();
        });
    }
}
exports.CloseVstConnection = CloseVstConnection;
//# sourceMappingURL=CloseVstConnection.js.map